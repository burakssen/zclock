...
pub fn init(screen_width: i32, screen_height: i32) Layout {
    ...
    const total_gaps = 9.0 * gap_between_digits;
    ...
    const colon_y = start_y + digit_height / 2.0;
    const colon_draw_x1 = digit_positions[1] + digit_width + gap_width_colon / 2.0;
    const colon_draw_x2 = digit_positions[3] + digit_width + gap_width_colon / 2.0;
    ...
    return .{
        ...
        .colon_y = colon_y,
        .colon_draw_x1 = colon_draw_x1,
        .colon_draw_x2 = colon_draw_x2,
    };
}
